...
print(cars["Lamborghini"]["Model"]) # Output------> Aventador

# the .popitem removes the last inserted pair
x = cars.popitem()
print(x,"was the last inserted pair in the dictionary of cars") # Output-----> ('Bentley', {'Model': 'Bentayga', 'Make': 'Bentley', 'Year': 2023}) was the last inserted pair in the dictionary of cars
"""
Method---------->Description
